...
def exito_login():
    ...
    Button(ventana_exito, text="OK", command=kNN).pack() #EJECUTA "borrar_no_usuario()"
    Button(ventana_exito, text="KNN", command=borrar_no_usuario).pack() #EJECUTA "borrar_no_usuario()"
    #global ventana_exito
    #ventana_exito = Toplevel(ventana_login)
